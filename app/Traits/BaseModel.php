...
trait BaseModel
{
     ...
     */
    public function getQueryableFields(): array
    {
        return property_exists($this, 'queryable') ? $this->queryable : ['id'];
    }
    ...
    public function getQueryFields(): array
    {
        ...
        $default = $this->getQueryableFields();
    ...
    public function getQueryFieldsWithRelationship(): array
    {
        ...
        foreach ($relationships as $relationship) {
            ...
            $relationshipObj = new $relationshipModel;
            $tableName = $relationshipObj->getTable();
            foreach ($relationshipObj->getFillable() as $field) {
                $fields[] = $tableName . '.' . $field;
            }
            if (method_exists($relationshipObj, 'getQueryableFields')) {
                foreach ($relationshipObj->getQueryableFields() as $field) {
                    $fields[] = $tableName . '.' . $field;
                }
            }
        }
     ...
     */
    public function getDynamicAppends(): array
    {
        ...
        return array_merge($allowedAppends, $this->getAppends());
    }
